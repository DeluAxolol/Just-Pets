...
public interface JerboaVariant extends WeightedEntry {
    ...
    Codec<JerboaVariant> DIRECT_CODEC = ExtraCodecs.lazyInitializedCodec(ModJerboaVariants.JERBOA_VARIANT_SERIALIZER_REGISTRY::byNameCodec).dispatch(JerboaVariant::codec, Function.identity());
